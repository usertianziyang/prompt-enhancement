...
export const zh = {
  ...
  confirmRestoreDescription: '目标会话已有未发送草稿。恢复增强结果会覆盖该草稿。', confirmDeleteTitle: '删除增强历史？',
...
export const en = {
  ...
  confirmRestoreDescription: 'The target session has an unsent draft. Restoring this result will replace it.', confirmDeleteTitle: 'Delete enhancement history?',
